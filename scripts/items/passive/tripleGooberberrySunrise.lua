...
mod.CollectibleType.COLLECTIBLE_TRIPLE_GOOBERBERRY_SUNRISE = Isaac.GetItemIdByName("Triple Gooberberry Sunrise")

TGS.COLLECTIBLE_ID = mod.CollectibleType.COLLECTIBLE_TRIPLE_GOOBERBERRY_SUNRISE
