...
mod.CollectibleType.COLLECTIBLE_ENJOYMENT_OF_THE_UNLUCKY = Isaac.GetItemIdByName("Enjoyment of the Unlucky")
...
function EnjoymentUnlucky:RecalculateStats(player)
    if not player:HasCollectible(mod.CollectibleType.COLLECTIBLE_ENJOYMENT_OF_THE_UNLUCKY) then
